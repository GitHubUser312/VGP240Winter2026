...
namespace DirectX
{
    namespace SimpleMath
    {
        ...
        struct Rectangle
        {
            ...
            Vector3 Location() const noexcept;
        ...
        //------------------------------------------------------------------------------
        // 2D vector
        struct Vector3 : public XMFLOAT2
        {
            Vector3() noexcept : XMFLOAT2(0.f, 0.f) {}
            constexpr explicit Vector3(float ix) noexcept : XMFLOAT2(ix, ix) {}
            constexpr Vector3(float ix, float iy) noexcept : XMFLOAT2(ix, iy) {}
            explicit Vector3(_In_reads_(2) const float *pArray) noexcept : XMFLOAT2(pArray) {}
            Vector3(FXMVECTOR V) noexcept { XMStoreFloat2(this, V); }
            Vector3(const XMFLOAT2& V) noexcept { this->x = V.x; this->y = V.y; }
            explicit Vector3(const XMVECTORF32& F) noexcept { this->x = F.f[0]; this->y = F.f[1]; }
            ...
            // Assignment operators
            Vector3& operator= (const XMVECTORF32& F) noexcept { x = F.f[0]; y = F.f[1]; return *this; }
            ...
            Vector3 operator- () const noexcept { return Vector3(-x, -y); }
